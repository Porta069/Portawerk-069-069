...
export default function ProfileScore({ score }: { score: Score }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-5">
        <div className="relative flex-shrink-0" style={{ width: 124, height: 124 }}>
          <svg width="124" height="124" viewBox="0 0 124 124" className="-rotate-90">
            <circle cx="62" cy="62" r={r} fill="none" stroke="#EDE8DE" strokeWidth="11" />
            <motion.circle
              cx="62"
              cy="62"
              r={r}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-[10px] mt-1" style={{ color: "rgba(12, 51, 48,0.4)" }}>
              vollständig
            </span>
          </div>
        </div>
        ...
        <div className="min-w-0 flex-1">
          {score.gaps.length === 0 ? (
            ...
            <>
              <p className="text-[14px] leading-relaxed" style={{ color: "rgba(12, 51, 48,0.65)" }}>
              ...
              {top && (
                <Link
                  ...
                  style={{
                    ...
                    boxShadow: "0 12px 24px -14px rgba(249, 173, 7,0.9)",
                  }}
                >
                  {top.label}
                  <span
                    className="rounded-full px-1.5 py-0.5 text-[11px] tabular-nums"
                    style={{ background: "rgba(12, 51, 48,0.14)" }}
                  >
                    +{top.extraJobs}
                  </span>
      ...
      {score.gaps.length > 1 && (
        <ul className="mt-5 space-y-1.5" style={{ borderTop: "1px solid #EDE8DE", paddingTop: 14 }}>
