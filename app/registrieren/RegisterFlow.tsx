...
const STEPS: StepMeta[] = [
  {
    key: "ausbildung",
    label: "Gewerk",
    h: "In welchem Gewerk arbeitest du?",
    s: "Dein Gewerk und dein Abschluss entscheiden, welche Betriebe überhaupt in Frage kommen.",
    photo: "/images/elektriker-werkstatt.jpg",
    tip: "Betriebe suchen fast immer in genau einem Gewerk. Wer ein anderes sucht, taucht bei dir gar nicht erst auf — das spart dir die Absagen.",
  },
  {
    key: "erfahrung",
    label: "Erfahrung",
    h: "Was bringst du mit?",
    s: "Deine Position, deine Jahre, deine Verantwortung — das wiegt im Matching am schwersten.",
  ...
  },
  {
    ...
    s: "Montage, Führerschein, Sprache, Start und dein Gehaltswunsch.",
